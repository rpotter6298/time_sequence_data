...
#     observed_t_stat = stats.ttest_ind(val[grp==1], val[grp==2], equal_var=True).statistic
...
# def bootstrap_t_test_old(array1, array2, n_bootstrap=1000, ci=0.95):
...
class analysis_module:
    ...
    def prepare_lineplot(
        self, module, treatments: List = None, output_path: Path = None
    ):
